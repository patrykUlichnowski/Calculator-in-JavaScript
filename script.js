  ...
  for (let i = 0; i < operatorsArray.length; i++) {
    ...
    switch (i) {
      ...
      case 3:
        ...
        break;
      case 4:
        operatorsArray[i].sign = "sqrt";
        break;
      case 5:
        operatorsArray[i].sign = "C";
        break;
      case 6:
        operatorsArray[i].sign = "=";
        break;
...
function userInput(event) {
  ...
  if (memorizedNumber !== undefined && exist && result !== 0) {
    // TUTAJ
    console.log("jest"); // TUTAJ
    memorizedNumber = userInputNumber; // TUTAJ
  }
}
setInterval(() => console.log(memorizedNumber, userInputNumber, exist), 1000);
  ...
  if (triger !== "=" || triger === "sqrt" || triger === "C") {
    ...
    if (triger === "sqrt") {
      ...
      if (triger === "C") {
        ...
        if (
          memorizedNumber === undefined ||
          memorizedNumber === userInputNumber ||
          exist // TUTAJ
        ) {
    ...
    switch (sign) {
      ...
      case "+":
        result = Number(Number(memorizedNumber) + Number(userInputNumber));
        break;
      case "-":
        result = Number(Number(memorizedNumber) - Number(userInputNumber));
        break;
